...
obj.filter <- obj[rownames(obj) %in% rownames(obj.cells[["ptm.ratio"]]),]
```
...
### MS1
```{r}
dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/6-technical-variability/auto/batch-corrected")
...
colnames(df) <- c("10 pg histone standard",
                  sub(".*_Plate\\d+_(.*?)_annotated.*", "\\1", list.files("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/1-data/bulk/malvina",
                                                                           pattern = "LINCS")))
