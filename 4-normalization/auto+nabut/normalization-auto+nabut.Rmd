...
```{r}
dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/filtered")
...
### MS1
```{r}
dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/normalization")
setwd("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/normalization")
...
pdf("MS1.log2.center.impute_experiment_pca.pdf",
    width = 5,
    height = 5)
biplot(p,
       colby = "experiment", 
...
pdf("MS2.log2.center.impute_experiment_pca.pdf",
    width = 5,
    height = 5)
biplot(p,
       colby = "experiment", 
...
```{r}
dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/tables")
setwd("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/tables")
...
eigencorplot(p,
             ...
             main = "Principle component correlations",
             cexMain = 1.5,
             metavars = c("experiment_replicate", "multiplier", "total.ms1"),
             col = viridis(100),
             colCorval = 'firebrick',
             fontCorval = 2,
             cexCorval = 0.5,
...
# Batch correction
- Each replicate plate is a batch. Combine the experiment and replicate variable since the replicate variables are specific to each experiment
```{r}
obj.filter$experiment_replicate <- paste(obj.filter$experiment, obj.filter$replicate, sep = "_")
obj.filter.ratio.multi$experiment_replicate <- paste(obj.filter.ratio.multi$experiment, obj.filter.ratio.multi$replicate, sep = "_")
```
...
### MS1
```{r}
# dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/batchqc")
# setwd("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/batchqc")

# assess batch effects
# batchQC(assay(obj.filter, "MS1.log2.center.impute"), 
#         batch = obj.filter$replicate, 
#         condition = obj.filter$condition,
#         report_file="MS1.log2.center.impute.no-correction.html", report_dir=".", 
#         report_option_binary="111111111",
#         view_report=FALSE, interactive=FALSE, batchqc_output=FALSE)


# # only keep controls, then adjust for batch
# obj.filter.control <- obj.filter[,obj.filter$condition == "control"]
# 
# # correct for the effect of the replicates
# # not working but there is no mix in the auto, only control
# assays(obj.filter.control, withDimnames=FALSE)[["MS1.log2.center.impute.combat"]] <- as.data.frame(ComBat(dat = assay(obj.filter.control, "MS1.log2.center.impute"), 
#                                                                batch = obj.filter.control$experiment))
...
assays(obj.filter, withDimnames=FALSE)[["MS1.log2.center.impute.batchCorrect"]] <- removeBatchEffect(assay(obj.filter, "MS1.log2.center.impute"),
                                                                                                       batch = obj.filter$experiment_replicate,
                                                                                                       group = obj.filter$condition)

# heatmap
dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/batch-corrected")
setwd("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/batch-corrected")
...
pdf("MS1.log2.center.impute.combat_heatmap.pdf",
    width = 10,
    height = 10)
set.seed(123)
Heatmap(assay(obj.filter, "MS1.log2.center.impute.batchCorrect"),
        top_annotation = column_ha,
        right_annotation = row_ha,
        heatmap_legend_param = list(title = "Normalized MS1 area"),
        cluster_rows = TRUE,
        cluster_columns = TRUE,
        show_column_names = FALSE,
        row_names_gp = gpar(fontsize = 10))
...
eigencorplot(p,
             main = "Principle component correlations",
             cexMain = 1.5,
             metavars = c("replicate", "date", "run_id", "multiplier", "experiment", "total.ms1"),
             col = viridis(100),
             colCorval = 'firebrick',
             fontCorval = 2,
             cexCorval = 0.5,
...
pdf("MS1.log2.center.combat_experiment_pca.pdf",
    width = 5,
    height = 5)
biplot(p,
       colby = "experiment", 
...
# assess batch effects
# batchQC(assay(obj.filter, "MS2.log2.center.impute"), 
#         batch = obj.filter$replicate, 
#         condition = obj.filter$condition,
#         report_file="MS2.log2.center.impute.no-correction.html", report_dir=".", 
#         report_option_binary="111111111",
#         view_report=FALSE, interactive=FALSE, batchqc_output=FALSE)

# correct batch using combat
# keeping the number of cells and condition be variables of interest
# pdata <- data.frame(colnames(obj.filter), obj.filter$experiment_replicate, obj.filter$multiplier, obj.filter$condition)
# modmatrix = model.matrix(~as.integer(obj.filter$multiplier) + obj.filter$condition, data=pdata)
# assays(obj.filter, withDimnames=FALSE)[["MS2.log2.center.impute.combat"]] <- as.data.frame(ComBat(dat = assay(obj.filter, "MS2.log2.center.impute"), 
#                                                                batch = obj.filter$experiment_replicate, 
#                                                                mod = modmatrix))
...
pdf("MS2.log2.center.impute.combat_heatmap.pdf",
    width = 10,
    height = 10)
set.seed(123)
Heatmap(scale(assay(obj.filter, "MS2.log2.center.impute.batchCorrect"), center = FALSE, scale = FALSE),
        top_annotation = column_ha,
        right_annotation = row_ha,
        heatmap_legend_param = list(title = "Normalized MS2 area"),
        cluster_rows = TRUE,
        cluster_columns = TRUE,
        show_column_names = FALSE,
        row_names_gp = gpar(fontsize = 10))
...
eigencorplot(p,
             main = "Principle component correlations",
             cexMain = 1.5,
             metavars = c("replicate", "date", "run_id", "multiplier", "experiment", "total.ms2"),
             col = viridis(100),
             colCorval = 'firebrick',
             fontCorval = 2,
             cexCorval = 0.5,
...
pdf("MS2.log2.center.combat_experiment_pca.pdf",
    width = 5,
    height = 5)
biplot(p,
       colby = "experiment", 
...
### MS1
- Coefficients not estimable: grouptreat 
```{r}
dir.create("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/batch-corrected")
setwd("/Users/ronaldcutler/Dropbox\ (EinsteinMed)/Sidoli-lab/Projects/Single-cell-histone/Analysis/4-normalization/auto+nabut/batch-corrected")
...
eigencorplot(p,
             ...
             main = "Principle component correlations",
             cexMain = 1.5,
             metavars = c("experiment_replicate", "multiplier", "condition", "total.ms1"),
             col = viridis(100),
             colCorval = 'firebrick',
             fontCorval = 2,
             cexCorval = 0.5,
...
eigencorplot(p,
             main = "Principle component correlations",
             cexMain = 1.5,
             metavars = c("replicate", "date", "run_id", "multiplier", "experiment", "condition", "total.ms2"),
             col = viridis(100),
             colCorval = 'firebrick',
             fontCorval = 2,
             cexCorval = 0.5,
